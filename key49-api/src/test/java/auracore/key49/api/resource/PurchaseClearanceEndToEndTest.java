...
class PurchaseClearanceEndToEndTest {
    ...
    void setupTenantAndApiKey() {
        ...
        pgPool.preparedQuery("""
                ...
                .execute(Tuple.of(tenantId, TENANT_RUC, "E2E PurchaseClearance Corp S.A.", "E2E PC", "Quito",
                        TENANT_SCHEMA))
                .await().indefinitely();
        ...
        pgPool.preparedQuery("""
                ...
                .execute(Tuple.of(UUID.randomUUID(), tenantId, generated.keyPrefix(), generated.hash(), "e2e-pc-key"))
                .await().indefinitely();
    ...
    void shouldVoidAuthorizedDocument() {
        ...
        pgPool.preparedQuery(
                ...
                .execute(Tuple.of("0504202603179001691900110010010000000021234567813", docId))
                .await().indefinitely();
    ...
    void shouldRejectVoid_withoutReason() {
        ...
        pgPool.preparedQuery(
                "UPDATE %s.documents SET status = 'AUTHORIZED', access_key = $1 WHERE document_id = $2::uuid"
                        .formatted(TENANT_SCHEMA))
                .execute(Tuple.of("0504202603179001691900110010010000000031234567816", docId))
                .await().indefinitely();
