...
class PortalEndToEndTest {
    ...
    void setup() {
        ...
        pgPool.preparedQuery("""
                ...
                .execute(Tuple.of(tenantId, "0990000000001", "Portal Test Corp S.A.", "Portal Test", "Guayaquil", TENANT_SCHEMA))
                .await().indefinitely();
        ...
        pgPool.preparedQuery("""
                ...
                .execute(Tuple.of(UUID.randomUUID(), tenantId, generated.keyPrefix(), generated.hash(), "portal-e2e-key"))
                .await().indefinitely();

        // Create schema, documents table, and outbox table
    ...
    // ── 5. Dashboard with authenticated session ──
    @Test
    @Order(5)
    ...
    // ── 6. Dashboard with status filter ──
    @Test
    @Order(6)
    ...
    // ── 8. Document detail for non-existent document ──
    @Test
    @Order(8)
    ...
    // ── 9. Status badge via HTMX endpoint ──
    @Test
    @Order(9)
    ...
    void shouldLogout() {
        ...
        // After logout, portal should redirect to login
        RestAssured.given()
                .cookie("KEY49_SESSION", sessionCookie)
                .redirects().follow(false)
                .when()
