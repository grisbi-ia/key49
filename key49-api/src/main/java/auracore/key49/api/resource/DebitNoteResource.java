...
public class DebitNoteResource {
    ...
    public Uni<Response> create(
        ...
        return debitNoteService.createDebitNote(request, idempotencyKey, requestIp)
                .map(doc -> {
    ...
    public Uni<Response> getById(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        return debitNoteService.findById(id)
                .map(doc -> {
    ...
    public Uni<Response> list(
        ...
        String requestId = generateRequestId();
        return debitNoteService.listDebitNotes(status, dateFrom, dateTo, recipientId, accessKey,
                page, perPage, sort)
                .map(result -> {
    ...
    public Uni<Response> resendEmail(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        return debitNoteService.resendEmail(id)
                .map(sentAt -> {
    ...
    @POST
    @Path("/{id}/void")
    public Uni<Response> voidDebitNote(@PathParam("id") UUID id, VoidRequest request) {
        String requestId = generateRequestId();
        return debitNoteService.voidDebitNote(id, request != null ? request.reason() : null)
                .map(doc -> {
