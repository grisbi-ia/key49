...
public class DebitNoteService {
    ...
    public Uni<Document> createDebitNote(CreateDebitNoteRequest request, String idempotencyKey, String requestIp) {
    ...
    private Uni<Document> checkUniquenessAndPersist(Mutiny.Session session, CreateDebitNoteRequest request,
    ...
    private Uni<Document> persistNewDocument(Mutiny.Session session, CreateDebitNoteRequest request,
                                              String idempotencyKey, String requestIp) {
    ...
    public Uni<PagedResult> listDebitNotes(String status, LocalDate dateFrom, LocalDate dateTo,
    ...
    public Uni<Document> voidDebitNote(UUID id, String reason) {
