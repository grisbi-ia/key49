...
public class CreditNoteService {
    ...
    public Uni<Document> createCreditNote(CreateCreditNoteRequest request, String idempotencyKey, String requestIp) {
    ...
    private Uni<Document> checkUniquenessAndPersist(Mutiny.Session session, CreateCreditNoteRequest request,
    ...
    private Uni<Document> persistNewDocument(Mutiny.Session session, CreateCreditNoteRequest request,
                                              String idempotencyKey, String requestIp) {
    ...
    public Uni<PagedResult> listCreditNotes(String status, LocalDate dateFrom, LocalDate dateTo,
    ...
    public Uni<Document> voidCreditNote(UUID id, String reason) {
