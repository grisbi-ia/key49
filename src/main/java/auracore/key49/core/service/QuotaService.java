...
/**
 * Gestiona la cuota de documentos por tenant. Provee incremento
 * atómico al crear documentos y decremento al rechazarlos o fallarlos.
 */
@ApplicationScoped
public class QuotaService {
     ...
     * y disponibilidad de cuota con un UPDATE atómico que previene race conditions.
     *
    ...
    /**
     * Libera una unidad de cuota cuando un documento es rechazado o falla.
