...
public class CreditNoteResource {
    ...
    public Response create(
        ...
        var doc = creditNoteService.createCreditNote(request, idempotencyKey, requestIp);
    ...
    public Response getById(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var doc = creditNoteService.findById(id);
    ...
    public Response list(
        ...
        String requestId = generateRequestId();
        var result = creditNoteService.listCreditNotes(status, dateFrom, dateTo, recipientId, accessKey,
                page, perPage, sort);
    ...
    public Response resendEmail(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var sentAt = creditNoteService.resendEmail(id);
