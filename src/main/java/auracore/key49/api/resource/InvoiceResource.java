...
public class InvoiceResource {
    ...
    public Response create(
        ...
        var doc = invoiceService.createInvoice(request, idempotencyKey, requestIp);
    ...
    public Response getById(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var doc = invoiceService.findById(id);
    ...
    public Response list(
        ...
        String requestId = generateRequestId();
        var result = invoiceService.listInvoices(status, dateFrom, dateTo, recipientId, accessKey, documentType,
                page, perPage, sort);
    ...
    public Response resendEmail(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var sentAt = invoiceService.resendEmail(id);
