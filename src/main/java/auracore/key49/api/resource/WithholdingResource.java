...
public class WithholdingResource {
    ...
    public Response create(
        ...
        var doc = withholdingService.createWithholding(request, idempotencyKey, requestIp);
    ...
    public Response getById(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var doc = withholdingService.findById(id);
    ...
    public Response list(
        ...
        String requestId = generateRequestId();
        var result = withholdingService.listWithholdings(status, dateFrom, dateTo, recipientId, accessKey,
                page, perPage, sort);
    ...
    public Response resendEmail(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var sentAt = withholdingService.resendEmail(id);
