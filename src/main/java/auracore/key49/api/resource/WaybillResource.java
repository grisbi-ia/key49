...
public class WaybillResource {
    ...
    public Response create(
        ...
        var doc = waybillService.createWaybill(request, idempotencyKey, requestIp);
    ...
    public Response getById(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var doc = waybillService.findById(id);
    ...
    public Response list(
        ...
        String requestId = generateRequestId();
        var result = waybillService.listWaybills(status, dateFrom, dateTo, recipientId, accessKey,
                page, perPage, sort);
    ...
    public Response resendEmail(@PathParam("id") UUID id) {
        String requestId = generateRequestId();
        var sentAt = waybillService.resendEmail(id);
    ...
    @POST
    @Path("/{id}/void")
    public Response voidWaybill(@PathParam("id") UUID id, VoidRequest request) {
        String requestId = generateRequestId();
        var doc = waybillService.voidWaybill(id, request != null ? request.reason() : null);
