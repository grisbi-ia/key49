...
# ============================================================================
# Uso:
#   chmod +x test-curls-prod.sh
#   ./test-curls-prod.sh factura
#   ./test-curls-prod.sh nota_credito
#   ./test-curls-prod.sh nota_debito
#   ./test-curls-prod.sh liquidacion
#   ./test-curls-prod.sh guia_remision
#   ./test-curls-prod.sh retencion
#   ./test-curls-prod.sh todos
# ============================================================================

BASE_URL="https://key49.apx5.com/v1"
AUTH="Authorization: Bearer k49_CTB4Blh5hSJsmjGlTfrJ9nUd"
