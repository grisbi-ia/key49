...
# ============================================================================
# Uso:
#   chmod +x scripts/test-curls.sh
#   ./scripts/test-curls.sh factura
#   ./scripts/test-curls.sh nota_credito
#   ./scripts/test-curls.sh nota_debito
#   ./scripts/test-curls.sh liquidacion
#   ./scripts/test-curls.sh guia_remision
#   ./scripts/test-curls.sh retencion
#   ./scripts/test-curls.sh todos
# ============================================================================
...
BASE_URL="${KEY49_BASE_URL:-http://localhost:8080/v1}"
